...
@Component
public class ServeAuthorizedListener implements TaskListener {

    private static final Logger LOGGER = LoggerFactory.getLogger(ServeAuthorizedListener.class);

    @Override
    public String getTopicName() {
        return "ServeAuthorizedTopic";
    }
